...
public class AppConfig
{
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory()
    {
        ...
        factoryBean.setPackagesToScan( new String[] { "org.tpsi.plane.core.model" } );
    ...
    private Properties hibProperties()
    {
        ...
        properties.put( "hibernate.ejb.naming_strategy", "org.tpsi.plane.core.cfg.CustomNamingStrategy" );
        return properties;
    }
